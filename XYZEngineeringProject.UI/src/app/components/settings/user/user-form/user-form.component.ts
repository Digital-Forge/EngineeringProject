...
export class UserFormComponent implements OnInit {
                    ...
                    next: (res) => {
                        ...
                        if (this.canModify() == true) {
                            if (this.userId && this.isInUrl('/edit')) {
                                ...
                                this.isCurrentUserAdmin = this.currentUser.roles.includes(RolesDB.Admin);
    ...
    saveChanges() {
        if (this.userForm.controls.userUserName.value && this.userForm.controls.userUserName.value != this.userDetails.userName) {
    ...
    canModify() {
        ...
        if(this.userId?.toLowerCase() == this.currentUser.id.toLowerCase()) {
            canModify = true;
        }
        if (this.currentUser) {
