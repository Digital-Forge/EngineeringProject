        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PathMask = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeepLevel = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessDirectories", x => new { x.DirectoryId, x.DepartmentId });
                    table.ForeignKey(
                        name: "FK_AccessDirectories_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccessDirectories_Directories_DirectoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessDirectories_DepartmentId",
                table: "AccessDirectories",
                column: "DepartmentId");
